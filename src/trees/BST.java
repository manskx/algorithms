...
public class BST {
	 ...
	 * isValid BST
	 */
	public static int isValidBST(BSTNode a) {
		return isBST(a, Integer.MIN_VALUE, Integer.MAX_VALUE) ? 1 : 0;

	}

	public static boolean isBST(BSTNode a, int min, int max) {
		...
		return isBST(a.left, min, a.data - 1) && isBST(a.right, a.data + 1, max);
	}
	...
	public static void minDepthBinarySearchTree() {
		...
		System.out.println("The minimum depth of " + "binary tree is : " + minDepth(root, 0));
	}
	...
	public static BSTNode ConstructTree(Integer i, Integer j, ArrayList<Integer> preOrder,
